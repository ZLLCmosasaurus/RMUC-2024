...
void Class_Referee::Data_Process()
{
    ...
    {
        memcpy(&Referee_Tx_Data_Interaction_Remote_Control, tmp_buffer->Data, sizeof(Struct_Referee_Tx_Data_Interaction_Remote_Control));
//			  //数据处理过程
//       Struct_DR16_UART_Data *tmp_buffer = (Struct_DR16_UART_Data *)Referee_Tx_Data_Interaction_Remote_Control;
...
//    Data.Yaw = (tmp_buffer->Channel_Yaw - Rocker_Offset) / Rocker_Num;
    ...
    {
        memcpy(&Interaction_Custom_Controller, tmp_buffer->Data, sizeof(Struct_Referee_Tx_Data_Interaction_Custom_Controller));
    }
    break;
    }
}
...
void Class_Referee::Data_Concatenation(Enum_Referee_Command_ID __Referee_Command_ID,uint8_t *__Data, uint16_t __Data_length)
{
	...
	/*  */
	HAL_UART_Transmit_DMA(UART_Manage_Object->UART_Handler, (uint8_t *)&Referee_Tx_UART_Data, DATA_FRAME_LENGTH + __Data_length);
}
