...
#ifndef DVC_AKMOTOR_H
#define DVC_AKMOTOR_H
 ...
 *
 */
enum Enum_AK_Motor_ID : uint16_t
{
...
public:
    ...
    void Init(CAN_HandleTypeDef *hcan, Enum_AK_Motor_ID __CAN_ID, Enum_AK_Motor_Control_Method __Control_Method = CAN_PACKET_SET_POS_SPD, int32_t __Position_Offset = 0, float __Omega_Max = 20.94359f, float __Torque_Max = 1000.0f);
	...
	inline void Set_Offset_Angle(float __Offset_Angle);
 ...
 * @return float 电机校准角度
 */
float Class_AK_Motor_80_6::Get_Offset_Angle()
{
    return (Offset_Angle);
}
 ...
 * @brief 设定电机校准值
 *
 * @param __Offset_Angle 电机校准角度
 */
void Class_AK_Motor_80_6::Set_Offset_Angle(float __Offset_Angle)
{
    Offset_Angle = __Offset_Angle;
}
#endif
