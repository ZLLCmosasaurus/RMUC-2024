 ...
 * @return float 电机校准角度
 */
float Class_DJI_Motor_C610::Get_Offset_Angle()
{
    return (Offset_Angle);
}
/**
 ...
 */
void Class_DJI_Motor_C610::Set_Offset_Angle(float __Offset_Angle)
{
 ...
 * @return float 电机校准角度
 */
float Class_DJI_Motor_C620::Get_Offset_Angle()
{
    return (Offset_Angle);
}
 ...
 * @param __Offset_Angle 电机校准角度
 */
void Class_DJI_Motor_C620::Set_Offset_Angle(float __Offset_Angle)
{
    Offset_Angle = __Offset_Angle;
}
