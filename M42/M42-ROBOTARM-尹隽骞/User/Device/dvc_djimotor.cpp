 ...
 *
 */
void Class_DJI_Motor_GM6020::Task_Alive_PeriodElapsedCallback()
{
    //判断该时间段内是否接收过电机数据
    if (Flag == Pre_Flag)
    {
 ...
 *
 */
void Class_DJI_Motor_GM6020::Task_PID_PeriodElapsedCallback()
{
 ...
 *
 */
void Class_DJI_Motor_C610::Task_Alive_PeriodElapsedCallback()
{
    //判断该时间段内是否接收过电机数据
    if (Flag == Pre_Flag)
    {
 ...
 *
 */
void Class_DJI_Motor_C610::Task_PID_PeriodElapsedCallback()
{
    switch (DJI_Motor_Control_Method)
    {
    case (DJI_Motor_Control_Method_OPENLOOP):
 ...
 *
 */
void Class_DJI_Motor_C620::Task_Alive_PeriodElapsedCallback()
{
    //判断该时间段内是否接收过电机数据
    if (Flag == Pre_Flag)
    {
 ...
 *
 */
void Class_DJI_Motor_C620::Task_PID_PeriodElapsedCallback()
{
    switch (DJI_Motor_Control_Method)
    {
    case (DJI_Motor_Control_Method_OPENLOOP):
